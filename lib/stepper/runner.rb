...
module Stepper
  class Runner
    ...
    def run!
      ...
      # Start the reactor!
      sucker = Stepper::Sucker.new(self.options)
      sucker.suck!
    end
    ...
    def setup_logging!
      if @log_file
        ...
        Stepper.logger = self.logger
        
        self.logger.info "Stepper Initialized..."
      end
    end
